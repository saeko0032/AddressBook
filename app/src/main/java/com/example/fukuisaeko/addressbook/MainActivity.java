...
import com.example.fukuisaeko.addressbook.addressbook.AddEditFragment;
import com.example.fukuisaeko.addressbook.addressbook.DetailFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null &&
            ...
            // tablet always display contactsFragment
            contactsFragment =
    ...
    public void onContactSelected(Uri contactUri) {
        if (findViewById(R.id.fragmentContainer) != null) // phone
            ...
            // removes top of back stack (btn-back)
    ...
    private void displayContact(Uri contactUri, int viewID) {
        ...
        // when you change fragment from activity, we need transaction
